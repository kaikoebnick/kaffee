![docker image](https://github.com/kaikoebnick/kaffee/actions/workflows/docker-publish.yml/badge.svg)
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/kaikoebnick/kaffee/raw/main/nomad-oasis.zip"
```
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/kaikoebnick/kaffee/manifests/main": unauthorized`
